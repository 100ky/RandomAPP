 ...
 * 
 * Tato komponenta využívá senzory zařízení (deviceorientation)          <div className={`${styles.compassAccuracy} ${styles[`accuracy_${compassAccuracy}`]}`}>
...
import compassExtras from '../styles/CompassExtras.module.css';
    ...
    return (
      <div 
        className={`
          ...
          ${isLandscape ? compassAnimations.landscapeOrientation : compassAnimations.portraitOrientation}
      ...
      >
        ...
        <div className={styles.compassInfo}>
          ...
          {isDeviceMoving && <div className={styles.movingIndicator}>Pohybujte telefonem v osmičce pro kalibraci</div>}
        </div>
      </div>
    );
  }
