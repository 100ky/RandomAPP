...
const SoundControls: React.FC = () => {
    ...
    const handleToggleSound = () => {
     ...
     return (
        <div className={styles.soundControls} style={buttonStyle}>
            <button
                ...
                aria-label={isSoundEnabled ? 'Vypnout zvuk' : 'Zapnout zvuk'}                style={{width: '48px', height: '48px', display: 'flex', alignItems: 'center', justifyContent: 'center'}}
            >
                {isSoundEnabled ? (
                    // Ikona pro zapnutý zvuk
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" fill="currentColor" style={{display: 'block'}}>
